...
- **Next runtime slice:** [SPE-2108](https://linear.app/spectranoir/issue/SPE-2108) self-censoring information registry (child of [SPE-1309](https://linear.app/spectranoir/issue/SPE-1309)) — see `planning/self-censoring-information-registry-slice-1.md`. [SPE-70](https://linear.app/spectranoir/issue/SPE-70) parent remains open for deferred anti-scan / out-of-phase families.

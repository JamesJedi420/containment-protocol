...
- **Intake registry wave (shipped on `main`):** [SPE-2105](https://linear.app/spectranoir/issue/SPE-2105) extranormal events (PR #2426), [SPE-2106](https://linear.app/spectranoir/issue/SPE-2106) unexplained locations (PR #2427), [SPE-2104](https://linear.app/spectranoir/issue/SPE-2104) minor anomaly items (PR #2428) — see `planning/extranormal-event-registry-slice-1.md` and `planning/minor-anomaly-item-registry-slice-1.md`. [SPE-854](https://linear.app/spectranoir/issue/SPE-854) parent remains open.
...
- **Public disclosure state registry (in PR):** [SPE-2109](https://linear.app/spectranoir/issue/SPE-2109) slice 1 (PR #2430) — see `planning/public-disclosure-state-registry-slice-1.md`. [SPE-1343](https://linear.app/spectranoir/issue/SPE-1343) parent remains open.
- **Next runtime slice:** [SPE-2110](https://linear.app/spectranoir/issue/SPE-2110) pattern source series intake registry (`patternSourceSeriesRegistry.ts` per `planning/harvest-reconciliation-index.md`) — after SPE-2109 merges. [SPE-70](https://linear.app/spectranoir/issue/SPE-70) parent remains open for deferred anti-scan / out-of-phase families.
...
**Recommended next step:** PR #2430 open ([SPE-2109](https://linear.app/spectranoir/issue/SPE-2109) public disclosure state registry). After merge: `git checkout main && git pull origin main`, then start a new agent for [SPE-2110](https://linear.app/spectranoir/issue/SPE-2110) pattern source series intake registry — draft slice doc from Linear, implement `patternSourceSeriesRegistry.ts` + tests per `planning/harvest-reconciliation-index.md`.

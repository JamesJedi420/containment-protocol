...
- **Next runtime slice:** [SPE-2105](https://linear.app/spectranoir/issue/SPE-2105) extranormal event registry (child of [SPE-854](https://linear.app/spectranoir/issue/SPE-854)) — see `planning/extranormal-event-registry-slice-1.md`. [SPE-70](https://linear.app/spectranoir/issue/SPE-70) parent remains open for deferred anti-scan / out-of-phase families.

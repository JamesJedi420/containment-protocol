...
- **Remaining under [SPE-70](https://linear.app/spectranoir/issue/SPE-70) umbrella:** post-matrix slices [SPE-2288](https://linear.app/spectranoir/issue/SPE-2288)–[SPE-2290](https://linear.app/spectranoir/issue/SPE-2290) (signature masking, false-detection output, glamour) — see `planning/hidden-modality-matrix-post-matrix-queue.md`; optional infiltration content depth in `planning/backlog.md`.

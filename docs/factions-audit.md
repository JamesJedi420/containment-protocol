...
approver provenance, an active request window, and a mission-fit deployable unit. The returned
audit record is not persisted and does not alter mission candidate ranking or SPE-2725 routing.

...
- **`ux/mission-triage.md`** — status-bar triage tail only (disposition actions shipped slice 5 / `planning/mission-triage-disposition-slice.md`; layout + row signals SPE-2255–2257).

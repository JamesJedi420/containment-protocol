**Harvest retrofit (rich)** — `facility-crisis-triage-metadata-55` → **SPE-1024** (part 1/1)
...
- **Candidates on SPE-1024:** C17
---

#### C17 — Hidden teamwork / pairing cohesion
...
- **Harvest summary:** Hidden teamwork / pairing cohesion
...
- **Table note:** Hidden teamwork / pairing cohesion
...
**Traceability:** `planning/facility-crisis-triage-metadata-55-harvest.md` (C17)

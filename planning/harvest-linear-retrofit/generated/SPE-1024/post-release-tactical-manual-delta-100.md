**Harvest retrofit (rich)** — `post-release-tactical-manual-delta-100` → **SPE-1024** (part 1/1)
...
- **Candidates on SPE-1024:** C1–C8
---

#### C1–C8 — Companion autonomy + doctrine panel deltas
...
- **Harvest summary:** Companion autonomy + doctrine panel deltas
...
- **Table note:** Companion autonomy + doctrine panel deltas

**4. Ownership & reconciliation**
- **Primary (this comment):** SPE-1024
- **Co-owners:** SPE-42

**5. Boundary**
**In scope (when owner ships):**
- Concrete acceptance delta on SPE-1024 when that issue's slice is implemented
...
**Traceability:** `planning/post-release-tactical-manual-delta-100-harvest.md` (C1–C8)

**Harvest retrofit (rich)** — `haunted-estate-dual-pressure-metadata-106` → **SPE-1025** (part 1/1)
...
- **Candidates on SPE-1025:** C30, C82
---

#### C30 — NPC team cohesion/fracture
...
- **Harvest summary:** NPC team cohesion/fracture
...
- **Table note:** NPC team cohesion/fracture
...
**Traceability:** `planning/haunted-estate-dual-pressure-metadata-106-harvest.md` (C30)

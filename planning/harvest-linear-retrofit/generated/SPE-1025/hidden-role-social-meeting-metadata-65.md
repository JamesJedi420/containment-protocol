**Harvest retrofit (rich)** — `hidden-role-social-meeting-metadata-65` → **SPE-1025** (part 1/1)
...
- **Candidates on SPE-1025:** C49, C51
---

#### C49 — Unlock social procedures via training/experience
...
- **Harvest summary:** Unlock social procedures via training/experience
...
- **Table note:** Unlock social procedures via training/experience
...
**Traceability:** `planning/hidden-role-social-meeting-metadata-65-harvest.md` (C49)

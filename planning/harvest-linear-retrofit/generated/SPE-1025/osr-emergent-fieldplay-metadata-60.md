**Harvest retrofit (rich)** — `osr-emergent-fieldplay-metadata-60` → **SPE-1025** (part 1/1)
...
- **Candidates on SPE-1025:** C9, C45
---

#### C9 — Micro-preparation / loadout layer
...
- **Harvest summary:** Micro-preparation / loadout layer
...
- **Table note:** Micro-preparation / loadout layer
...
**Traceability:** `planning/osr-emergent-fieldplay-metadata-60-harvest.md` (C9)

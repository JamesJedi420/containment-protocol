**Harvest retrofit (rich)** — `horror-tension-questionnaire-metadata-50` → **SPE-1034** (part 1/1)
...
- **Candidates on SPE-1034:** C35
---

#### C35 — Host-only truth layer vs player knowledge
...
- **Harvest summary:** Host-only truth layer vs player knowledge
...
- **Table note:** Host-only truth layer vs player knowledge
...
**Traceability:** `planning/horror-tension-questionnaire-metadata-50-harvest.md` (C35)

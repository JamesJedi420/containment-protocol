**Harvest retrofit (rich)** — `multi-stage-squad-operations-metadata-24` → **SPE-1034** (part 1/1)
...
- **Candidates on SPE-1034:** C9
---

#### C9 — Deployed-staff contextual commentary
...
- **Harvest summary:** Deployed-staff contextual commentary
...
- **Table note:** Deployed-staff contextual commentary
...
**Traceability:** `planning/multi-stage-squad-operations-metadata-24-harvest.md` (C9)

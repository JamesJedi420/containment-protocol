**Harvest retrofit (rich)** — `haunted-estate-dual-pressure-metadata-106` → **SPE-1052** (part 1/1)
...
- **Candidates on SPE-1052:** C70
---

#### C70 — Repairable signal/beacon assets
...
- **Harvest summary:** Repairable signal/beacon assets
...
- **Table note:** Repairable signal/beacon assets
...
**Traceability:** `planning/haunted-estate-dual-pressure-metadata-106-harvest.md` (C70)

**Harvest retrofit (rich)** — `mythic-campaign-traversal-delta-17` → **SPE-1052** (part 1/1)
...
- **Candidates on SPE-1052:** C27
---

#### C27 — Distributed operational anchors 
...
- **Harvest summary:** Distributed operational anchors (holdings/strongholds state)
...
- **Table note:** Distributed operational anchors (holdings/strongholds state)
...
**Traceability:** `planning/mythic-campaign-traversal-delta-17-harvest.md` (C27)

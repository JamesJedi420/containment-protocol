**Harvest retrofit (rich)** — `mythic-campaign-traversal-delta-17` → **SPE-1061** (part 1/1)
...
- **Candidates on SPE-1061:** C35
---

#### C35 — Scalable hostile-group abstraction 
...
- **Harvest summary:** Scalable hostile-group abstraction (`aggregateBattle` families)
...
- **Named modules in note:** `aggregateBattle`.
...
- **Table note:** Scalable hostile-group abstraction (`aggregateBattle` families)

**4. Ownership & reconciliation**
- **Primary (this comment):** SPE-1061
- **Co-owners:** SPE-42

**5. Boundary**
**In scope (when owner ships):**
- Concrete acceptance delta on SPE-1061 when that issue's slice is implemented
...
**Traceability:** `planning/mythic-campaign-traversal-delta-17-harvest.md` (C35)

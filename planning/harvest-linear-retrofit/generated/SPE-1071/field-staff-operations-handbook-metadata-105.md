**Harvest retrofit (rich)** — `field-staff-operations-handbook-metadata-105` → **SPE-1071** (part 1/1)
...
- **Candidates on SPE-1071:** C45–C49
---
...
- **Primary (this comment):** SPE-1071
- **Co-owners:** SPE-1734, SPE-1701

**5. Boundary**
**In scope (when owner ships):**
- Concrete acceptance delta on SPE-1071 when that issue's slice is implemented

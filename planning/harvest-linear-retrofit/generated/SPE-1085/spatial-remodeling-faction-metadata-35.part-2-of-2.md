**Harvest retrofit (rich)** — `spatial-remodeling-faction-metadata-35` → **SPE-1085** (part 2/2)
...
- **Candidates on SPE-1085:** C35
---

#### C35 — No source setting import
...
- **Harvest summary:** No source setting import
...
- **Table note:** No source setting import
...
**Traceability:** `planning/spatial-remodeling-faction-metadata-35-harvest.md` (C35)

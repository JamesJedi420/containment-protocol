**Harvest retrofit (rich)** — `spatial-remodeling-faction-metadata-35` → **SPE-110** (part 1/1)
...
- **Candidates on SPE-110:** C22, C31
---

#### C22 — Construction/maintenance as anomaly trigger
...
- **Harvest summary:** Construction/maintenance as anomaly trigger
...
- **Table note:** Construction/maintenance as anomaly trigger

**4. Ownership & reconciliation**
- **Primary (this comment):** SPE-110
- **Co-owners:** SPE-164

**5. Boundary**
**In scope (when owner ships):**
- Concrete acceptance delta on SPE-110 when that issue's slice is implemented
...
**Traceability:** `planning/spatial-remodeling-faction-metadata-35-harvest.md` (C22)
...
**5. Boundary**
**In scope (when owner ships):**
- Authoring guardrails and acceptance notes on SPE-110

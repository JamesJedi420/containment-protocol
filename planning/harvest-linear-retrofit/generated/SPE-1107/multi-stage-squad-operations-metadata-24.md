**Harvest retrofit (rich)** — `multi-stage-squad-operations-metadata-24` → **SPE-1107** (part 1/1)
...
- **Candidates on SPE-1107:** C3
---

#### C3 — Persistent trust/readiness/morale modifiers
...
- **Harvest summary:** Persistent trust/readiness/morale modifiers
...
- **Table note:** Persistent trust/readiness/morale modifiers
...
**Traceability:** `planning/multi-stage-squad-operations-metadata-24-harvest.md` (C3)

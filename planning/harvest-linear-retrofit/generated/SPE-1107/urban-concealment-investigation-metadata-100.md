**Harvest retrofit (rich)** — `urban-concealment-investigation-metadata-100` → **SPE-1107** (part 1/1)
...
- **Candidates on SPE-1107:** C18
---

#### C18 — Theme replacement after collapse
...
- **Harvest summary:** Theme replacement after collapse
...
- **Table note:** Theme replacement after collapse
...
**Traceability:** `planning/urban-concealment-investigation-metadata-100-harvest.md` (C18)

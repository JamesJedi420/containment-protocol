**Harvest retrofit (rich)** — `post-release-tactical-manual-delta-100` → **SPE-1120** (part 1/1)
...
- **Candidates on SPE-1120:** C81–C92
---

#### C81–C92 — Engine patterns; prefs no-op vs 104
...
- **Harvest summary:** Engine patterns; prefs no-op vs 104
...
- **Table note:** Engine patterns; prefs no-op vs 104

**4. Ownership & reconciliation**
- **Primary (this comment):** SPE-1120
- **Co-owners:** SPE-854, SPE-1734

**5. Boundary**
**In scope (when owner ships):**
- Concrete acceptance delta on SPE-1120 when that issue's slice is implemented
...
**Traceability:** `planning/post-release-tactical-manual-delta-100-harvest.md` (C81–C92)

**Harvest retrofit (rich)** — `post-release-tactical-manual-delta-100` → **SPE-1123** (part 1/1)
...
- **Candidates on SPE-1123:** C56–C66
---
...
- **Primary (this comment):** SPE-1123
- **Co-owners:** SPE-98

**5. Boundary**
**In scope (when owner ships):**
- Concrete acceptance delta on SPE-1123 when that issue's slice is implemented

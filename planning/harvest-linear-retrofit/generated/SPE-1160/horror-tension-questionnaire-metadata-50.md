**Harvest retrofit (rich)** — `horror-tension-questionnaire-metadata-50` → **SPE-1160** (part 1/1)
...
- **Candidates on SPE-1160:** C20
---

#### C20 — Moral-dilemma impossible-choice engine
...
- **Harvest summary:** Moral-dilemma impossible-choice engine
...
- **Table note:** Moral-dilemma impossible-choice engine
...
**Traceability:** `planning/horror-tension-questionnaire-metadata-50-harvest.md` (C20)

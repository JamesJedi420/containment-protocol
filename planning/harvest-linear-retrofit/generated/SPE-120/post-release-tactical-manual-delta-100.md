**Harvest retrofit (rich)** — `post-release-tactical-manual-delta-100` → **SPE-120** (part 1/1)
...
- **Candidates on SPE-120:** C67–C77
---

#### C67–C77 — Injury/combat; several no-op vs 104
...
- **Harvest summary:** Injury/combat; several no-op vs 104
...
- **Table note:** Injury/combat; several no-op vs 104

**4. Ownership & reconciliation**
- **Primary (this comment):** SPE-120
- **Co-owners:** SPE-40, SPE-55

**5. Boundary**
**In scope (when owner ships):**
- Concrete acceptance delta on SPE-120 when that issue's slice is implemented
...
**Traceability:** `planning/post-release-tactical-manual-delta-100-harvest.md` (C67–C77)

**Harvest retrofit (rich)** — `expedition-debt-players-edition-metadata-128` → **SPE-130** (part 1/1)
...
- **Candidates on SPE-130:** C11
---

#### C11 — Operational buffer vs harm track
...
- **Harvest summary:** Operational buffer vs harm track
...
- **Table note:** Operational buffer vs harm track
...
**Traceability:** `planning/expedition-debt-players-edition-metadata-128-harvest.md` (C11)

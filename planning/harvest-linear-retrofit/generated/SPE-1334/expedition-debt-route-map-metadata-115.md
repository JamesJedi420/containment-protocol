**Harvest retrofit (rich)** — `expedition-debt-route-map-metadata-115` → **SPE-1334** (part 1/1)
...
- **Candidates on SPE-1334:** C90
---

#### C90 — Shortcut surveillance
...
- **Harvest summary:** Shortcut surveillance
...
- **Table note:** Shortcut surveillance
...
**Traceability:** `planning/expedition-debt-route-map-metadata-115-harvest.md` (C90)

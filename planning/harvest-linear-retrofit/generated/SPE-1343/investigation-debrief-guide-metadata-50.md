**Harvest retrofit (rich)** — `investigation-debrief-guide-metadata-50` → **SPE-1343** (part 1/1)
...
- **Candidates on SPE-1343:** C33
---

#### C33 — Hostile leverage dossier social defense
...
- **Harvest summary:** Hostile leverage dossier social defense
...
- **Table note:** Hostile leverage dossier social defense

**4. Ownership & reconciliation**
- **Primary (this comment):** SPE-1343
- **Co-owners:** SPE-788

**5. Boundary**
**In scope (when owner ships):**
- Concrete acceptance delta on SPE-1343 when that issue's slice is implemented
...
**Traceability:** `planning/investigation-debrief-guide-metadata-50-harvest.md` (C33)

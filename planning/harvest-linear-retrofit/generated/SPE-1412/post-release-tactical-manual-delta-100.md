**Harvest retrofit (rich)** — `post-release-tactical-manual-delta-100` → **SPE-1412** (part 1/1)
...
- **Candidates on SPE-1412:** C23–C26
---
...
- **Primary (this comment):** SPE-1412
- **Co-owners:** SPE-1059, SPE-164

**5. Boundary**
**In scope (when owner ships):**
- Concrete acceptance delta on SPE-1412 when that issue's slice is implemented

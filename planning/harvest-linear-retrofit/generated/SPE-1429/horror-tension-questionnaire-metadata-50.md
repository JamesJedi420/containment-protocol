**Harvest retrofit (rich)** — `horror-tension-questionnaire-metadata-50` → **SPE-1429** (part 1/1)
...
- **Candidates on SPE-1429:** C1
---

#### C1 — Visible escalating instability meter 
...
- **Harvest summary:** Visible escalating instability meter (scene dread, not HP)
...
- **Table note:** Visible escalating instability meter (scene dread, not HP)
...
**Traceability:** `planning/horror-tension-questionnaire-metadata-50-harvest.md` (C1)

**Harvest retrofit (rich)** — `multi-stage-squad-operations-metadata-24` → **SPE-1443** (part 1/1)
...
- **Candidates on SPE-1443:** C8
---

#### C8 — Personnel-origin incident variants
...
- **Harvest summary:** Personnel-origin incident variants
...
- **Table note:** Personnel-origin incident variants
...
**Traceability:** `planning/multi-stage-squad-operations-metadata-24-harvest.md` (C8)

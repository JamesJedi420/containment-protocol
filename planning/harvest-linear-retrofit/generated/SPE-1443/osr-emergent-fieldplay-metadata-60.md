**Harvest retrofit (rich)** — `osr-emergent-fieldplay-metadata-60` → **SPE-1443** (part 1/1)
...
- **Candidates on SPE-1443:** C40
---

#### C40 — Randomized quick replacement staff
...
- **Harvest summary:** Randomized quick replacement staff
...
- **Table note:** Randomized quick replacement staff
...
**Traceability:** `planning/osr-emergent-fieldplay-metadata-60-harvest.md` (C40)

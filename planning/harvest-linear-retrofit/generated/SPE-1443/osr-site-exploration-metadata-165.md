**Harvest retrofit (rich)** — `osr-site-exploration-metadata-165` → **SPE-1443** (part 1/1)
...
- **Candidates on SPE-1443:** C143
---

#### C143 — Staff capability matrix
...
- **Harvest summary:** Staff capability matrix
...
- **Table note:** Staff capability matrix
...
**Traceability:** `planning/osr-site-exploration-metadata-165-harvest.md` (C143)

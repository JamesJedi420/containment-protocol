**Harvest retrofit (rich)** — `urban-concealment-investigation-metadata-100` → **SPE-1443** (part 1/1)
...
- **Candidates on SPE-1443:** C19
---

#### C19 — Ordinary-life resource + obligation
...
- **Harvest summary:** Ordinary-life resource + obligation
...
- **Table note:** Ordinary-life resource + obligation
...
**Traceability:** `planning/urban-concealment-investigation-metadata-100-harvest.md` (C19)

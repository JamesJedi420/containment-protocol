**Harvest retrofit (rich)** — `investigation-debrief-guide-metadata-50` → **SPE-1496** (part 1/1)
...
- **Candidates on SPE-1496:** C1
---

#### C1 — End-of-day debrief + unresolved questions 
...
- **Harvest summary:** End-of-day debrief + unresolved questions (extends contract debrief)
...
- **Table note:** End-of-day debrief + unresolved questions (extends contract debrief)
...
**Traceability:** `planning/investigation-debrief-guide-metadata-50-harvest.md` (C1)

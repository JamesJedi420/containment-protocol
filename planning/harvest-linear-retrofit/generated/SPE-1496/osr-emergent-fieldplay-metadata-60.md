**Harvest retrofit (rich)** — `osr-emergent-fieldplay-metadata-60` → **SPE-1496** (part 1/1)
...
- **Candidates on SPE-1496:** C16
---

#### C16 — Foray-retreat-return loop
...
- **Harvest summary:** Foray-retreat-return loop
...
- **Table note:** Foray-retreat-return loop
...
**Traceability:** `planning/osr-emergent-fieldplay-metadata-60-harvest.md` (C16)

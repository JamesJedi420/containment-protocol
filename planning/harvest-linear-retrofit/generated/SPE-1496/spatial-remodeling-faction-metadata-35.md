**Harvest retrofit (rich)** — `spatial-remodeling-faction-metadata-35` → **SPE-1496** (part 1/1)
...
- **Candidates on SPE-1496:** C15
---

#### C15 — Faction interview log + subject reliability
...
- **Harvest summary:** Faction interview log + subject reliability
...
- **Table note:** Faction interview log + subject reliability
...
**Traceability:** `planning/spatial-remodeling-faction-metadata-35-harvest.md` (C15)

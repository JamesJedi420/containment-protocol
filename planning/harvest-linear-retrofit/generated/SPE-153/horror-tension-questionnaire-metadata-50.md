**Harvest retrofit (rich)** — `horror-tension-questionnaire-metadata-50` → **SPE-153** (part 1/1)
...
- **Candidates on SPE-153:** C17
---

#### C17 — Suspense pacing + delayed-reveal toolkit
...
- **Harvest summary:** Suspense pacing + delayed-reveal toolkit
...
- **Table note:** Suspense pacing + delayed-reveal toolkit

**4. Ownership & reconciliation**
- **Primary (this comment):** SPE-153
- **Co-owners:** SPE-160

**5. Boundary**
**In scope (when owner ships):**
- Concrete acceptance delta on SPE-153 when that issue's slice is implemented
...
**Traceability:** `planning/horror-tension-questionnaire-metadata-50-harvest.md` (C17)

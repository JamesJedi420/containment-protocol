**Harvest retrofit (rich)** — `field-staff-operations-handbook-metadata-105` → **SPE-1555** (part 1/1)
...
- **Candidates on SPE-1555:** C4–C6
---

#### C4–C6 — Jurisdiction, entry compliance, gift/grant economy
...
- **Harvest summary:** Jurisdiction, entry compliance, gift/grant economy
...
- **Table note:** Jurisdiction, entry compliance, gift/grant economy
...
**Traceability:** `planning/field-staff-operations-handbook-metadata-105-harvest.md` (C4–C6)

**Harvest retrofit (rich)** — `post-release-tactical-manual-delta-100` → **SPE-158** (part 1/1)
...
- **Candidates on SPE-158:** C12–C14
---

#### C12–C14 — Templates + modify flow; C14 no-op vs 104 C76
...
- **Harvest summary:** Templates + modify flow; C14 no-op vs 104 C76
...
- **Table note:** Templates + modify flow; C14 no-op vs 104 C76
...
**Traceability:** `planning/post-release-tactical-manual-delta-100-harvest.md` (C12–C14)

**Harvest retrofit (rich)** — `expedition-debt-players-edition-metadata-128` → **SPE-16** (part 2/2)
...
- **Candidates on SPE-16:** C101
---

#### C101 — Bureaucratic debt-office mission source
...
- **Harvest summary:** Bureaucratic debt-office mission source
...
- **Table note:** Bureaucratic debt-office mission source
...
**Traceability:** `planning/expedition-debt-players-edition-metadata-128-harvest.md` (C101)

**Harvest retrofit (rich)** — `spatial-remodeling-faction-metadata-35` → **SPE-16** (part 1/1)
...
- **Candidates on SPE-16:** C16
---

#### C16 — Remodeling aftermath case-cluster generator
...
- **Harvest summary:** Remodeling aftermath case-cluster generator
...
- **Table note:** Remodeling aftermath case-cluster generator
...
**Traceability:** `planning/spatial-remodeling-faction-metadata-35-harvest.md` (C16)

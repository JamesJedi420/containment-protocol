**Harvest retrofit (rich)** — `campaign-readiness-mission-hub-metadata-96` → **SPE-160** (part 1/1)
...
- **Candidates on SPE-160:** C25
---

#### C25 — Compact field-operation schema
...
- **Harvest summary:** Compact field-operation schema
...
- **Table note:** Compact field-operation schema
...
**Traceability:** `planning/campaign-readiness-mission-hub-metadata-96-harvest.md` (C25)

**Harvest retrofit (rich)** — `field-staff-operations-handbook-metadata-105` → **SPE-161** (part 1/1)
...
- **Primary (this comment):** SPE-161
- **Co-owners:** SPE-158, SPE-677

**5. Boundary**
**In scope (when owner ships):**
- Concrete acceptance delta on SPE-161 when that issue's slice is implemented

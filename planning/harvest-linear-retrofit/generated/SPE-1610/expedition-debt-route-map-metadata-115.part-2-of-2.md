**Harvest retrofit (rich)** — `expedition-debt-route-map-metadata-115` → **SPE-1610** (part 2/2)
...
- **Candidates on SPE-1610:** C111
---

#### C111 — Aliens not invader-only
...
- **Harvest summary:** Aliens not invader-only
...
- **Table note:** Aliens not invader-only
...
**Traceability:** `planning/expedition-debt-route-map-metadata-115-harvest.md` (C111)

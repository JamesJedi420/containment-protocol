**Harvest retrofit (rich)** — `spatial-remodeling-faction-metadata-35` → **SPE-168** (part 1/1)
...
- **Candidates on SPE-168:** C21
---

#### C21 — Anomalous contractor permit verification
...
- **Harvest summary:** Anomalous contractor permit verification
...
- **Table note:** Anomalous contractor permit verification

**4. Ownership & reconciliation**
- **Primary (this comment):** SPE-168
- **Co-owners:** SPE-35

**5. Boundary**
**In scope (when owner ships):**
- Concrete acceptance delta on SPE-168 when that issue's slice is implemented
...
**Traceability:** `planning/spatial-remodeling-faction-metadata-35-harvest.md` (C21)

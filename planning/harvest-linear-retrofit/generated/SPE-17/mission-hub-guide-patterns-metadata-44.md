**Harvest retrofit (rich)** — `mission-hub-guide-patterns-metadata-44` → **SPE-17** (part 1/1)
...
- **Candidates on SPE-17:** C4
---

#### C4 — Team capability coverage 
...
- **Harvest summary:** Team capability coverage (substrate exists)
...
- **Table note:** Team capability coverage (substrate exists)

**4. Ownership & reconciliation**
- **Primary (this comment):** SPE-17
- **Co-owners:** SPE-1025

**5. Boundary**
**In scope (when owner ships):**
- Concrete acceptance delta on SPE-17 when that issue's slice is implemented
...
**Traceability:** `planning/mission-hub-guide-patterns-metadata-44-harvest.md` (C4)

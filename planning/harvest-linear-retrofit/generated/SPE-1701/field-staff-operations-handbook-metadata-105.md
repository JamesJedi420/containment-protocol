**Harvest retrofit (rich)** — `field-staff-operations-handbook-metadata-105` → **SPE-1701** (part 1/1)
...
- **Candidates on SPE-1701:** C45–C49
---
...
- **Primary (this comment):** SPE-1701
- **Co-owners:** SPE-1071, SPE-1734

**5. Boundary**
**In scope (when owner ships):**
- Concrete acceptance delta on SPE-1701 when that issue's slice is implemented

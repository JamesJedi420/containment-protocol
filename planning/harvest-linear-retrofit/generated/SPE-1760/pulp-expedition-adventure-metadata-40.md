**Harvest retrofit (rich)** — `pulp-expedition-adventure-metadata-40` → **SPE-1760** (part 1/1)
...
- **Candidates on SPE-1760:** C15
---

#### C15 — Cross-era anomaly provenance chain
...
- **Harvest summary:** Cross-era anomaly provenance chain
...
- **Table note:** Cross-era anomaly provenance chain
...
**Traceability:** `planning/pulp-expedition-adventure-metadata-40-harvest.md` (C15)

**Harvest retrofit (rich)** — `field-staff-operations-handbook-metadata-105` → **SPE-196** (part 1/1)
...
- **Candidates on SPE-196:** C23–C26
---

#### C23–C26 — Rank, promotion review, team role coverage
...
- **Harvest summary:** Rank, promotion review, team role coverage
...
- **Table note:** Rank, promotion review, team role coverage

**4. Ownership & reconciliation**
- **Primary (this comment):** SPE-196
- **Co-owners:** SPE-1059, SPE-1025

**5. Boundary**
**In scope (when owner ships):**
- Concrete acceptance delta on SPE-196 when that issue's slice is implemented
...
**Traceability:** `planning/field-staff-operations-handbook-metadata-105-harvest.md` (C23–C26)

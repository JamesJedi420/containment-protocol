**Harvest retrofit (rich)** — `layered-case-concept-generator-metadata-70` → **SPE-208** (part 1/1)
...
- **Candidates on SPE-208:** C54, C63
---

#### C54 — Institutional exploitation driver
...
- **Harvest summary:** Institutional exploitation driver
...
- **Table note:** Institutional exploitation driver
...
**Traceability:** `planning/layered-case-concept-generator-metadata-70-harvest.md` (C54)

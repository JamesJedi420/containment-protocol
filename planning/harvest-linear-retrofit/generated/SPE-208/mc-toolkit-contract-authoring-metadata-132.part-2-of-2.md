**Harvest retrofit (rich)** — `mc-toolkit-contract-authoring-metadata-132` → **SPE-208** (part 2/2)
...
- **Candidates on SPE-208:** C117
---

#### C117 — Police/legal accountability
...
- **Harvest summary:** Police/legal accountability
...
- **Table note:** Police/legal accountability
...
**Traceability:** `planning/mc-toolkit-contract-authoring-metadata-132-harvest.md` (C117)

**Harvest retrofit (rich)** — `spatial-remodeling-faction-metadata-35` → **SPE-208** (part 1/1)
...
- **Candidates on SPE-208:** C25
---

#### C25 — Peace-maintenance constraint / peace meter
...
- **Harvest summary:** Peace-maintenance constraint / peace meter
...
- **Table note:** Peace-maintenance constraint / peace meter
...
**Traceability:** `planning/spatial-remodeling-faction-metadata-35-harvest.md` (C25)

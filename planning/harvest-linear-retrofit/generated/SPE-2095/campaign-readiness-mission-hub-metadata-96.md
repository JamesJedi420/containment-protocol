**Harvest retrofit (rich)** — `campaign-readiness-mission-hub-metadata-96` → **SPE-2095** (part 1/1)
...
- **Candidates on SPE-2095:** C64
---

#### C64 — Staff insight tags
...
- **Harvest summary:** Staff insight tags
...
**Traceability:** `planning/campaign-readiness-mission-hub-metadata-96-harvest.md` (C64)

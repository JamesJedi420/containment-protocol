**Harvest retrofit (rich)** — `governance-bureau-faction-metadata-82` → **SPE-2095** (part 1/1)
...
- **Candidates on SPE-2095:** C44
---

#### C44 — Named specialist reputation profile
...
- **Harvest summary:** Named specialist reputation profile
...
- **Table note:** Named specialist reputation profile
...
**Traceability:** `planning/governance-bureau-faction-metadata-82-harvest.md` (C44)

**Harvest retrofit (rich)** — `horror-tension-questionnaire-metadata-50` → **SPE-2095** (part 1/1)
...
- **Candidates on SPE-2095:** C11
---

#### C11 — Pre-case relationship web + threat hooks
...
- **Harvest summary:** Pre-case relationship web + threat hooks
...
- **Table note:** Pre-case relationship web + threat hooks

**4. Ownership & reconciliation**
- **Primary (this comment):** SPE-2095
- **Co-owners:** SPE-158

**5. Boundary**
**In scope (when owner ships):**
- Concrete acceptance delta on SPE-2095 when that issue's slice is implemented
...
**Traceability:** `planning/horror-tension-questionnaire-metadata-50-harvest.md` (C11)

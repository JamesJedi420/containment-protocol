**Harvest retrofit (rich)** — `layered-case-concept-generator-metadata-70` → **SPE-2095** (part 1/1)
...
- **Candidates on SPE-2095:** C41
---

#### C41 — Multi-layer NPC record fields
...
- **Harvest summary:** Multi-layer NPC record fields
...
- **Table note:** Multi-layer NPC record fields
...
**Traceability:** `planning/layered-case-concept-generator-metadata-70-harvest.md` (C41)

**Harvest retrofit (rich)** — `osr-site-exploration-metadata-165` → **SPE-2095** (part 1/1)
...
- **Candidates on SPE-2095:** C24
---

#### C24 — Hireling/contractor system
...
- **Harvest summary:** Hireling/contractor system
...
- **Table note:** Hireling/contractor system
...
**Traceability:** `planning/osr-site-exploration-metadata-165-harvest.md` (C24)

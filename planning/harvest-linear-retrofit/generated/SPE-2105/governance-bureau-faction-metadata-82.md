**Harvest retrofit (rich)** — `governance-bureau-faction-metadata-82` → **SPE-2105** (part 1/1)
...
- **Candidates on SPE-2105:** C6
---

#### C6 — Faction-specific classification taxonomy
...
- **Harvest summary:** Faction-specific classification taxonomy
...
- **Table note:** Faction-specific classification taxonomy
...
**Traceability:** `planning/governance-bureau-faction-metadata-82-harvest.md` (C6)

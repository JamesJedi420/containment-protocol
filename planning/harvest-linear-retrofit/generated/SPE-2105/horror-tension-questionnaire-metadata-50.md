**Harvest retrofit (rich)** — `horror-tension-questionnaire-metadata-50` → **SPE-2105** (part 1/1)
...
- **Candidates on SPE-2105:** C18
---

#### C18 — Supernatural entity rule constraint schema
...
- **Harvest summary:** Supernatural entity rule constraint schema
...
- **Table note:** Supernatural entity rule constraint schema
...
**Traceability:** `planning/horror-tension-questionnaire-metadata-50-harvest.md` (C18)

**Harvest retrofit (rich)** — `urban-concealment-investigation-metadata-100` → **SPE-2105** (part 1/1)
...
- **Candidates on SPE-2105:** C7
---

#### C7 — Symbolic-pattern anomaly template
...
- **Harvest summary:** Symbolic-pattern anomaly template
...
- **Table note:** Symbolic-pattern anomaly template
...
**Traceability:** `planning/urban-concealment-investigation-metadata-100-harvest.md` (C7)

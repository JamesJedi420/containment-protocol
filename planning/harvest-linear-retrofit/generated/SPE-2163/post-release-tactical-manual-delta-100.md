**Harvest retrofit (rich)** — `post-release-tactical-manual-delta-100` → **SPE-2163** (part 1/1)
...
- **Candidates on SPE-2163:** C27–C30
---

#### C27–C30 — Covert placement; timed devices
...
- **Harvest summary:** Covert placement; timed devices
...
- **Table note:** Covert placement; timed devices

**4. Ownership & reconciliation**
- **Primary (this comment):** SPE-2163
- **Co-owners:** SPE-164

**5. Boundary**
**In scope (when owner ships):**
- Concrete acceptance delta on SPE-2163 when that issue's slice is implemented
...
**Traceability:** `planning/post-release-tactical-manual-delta-100-harvest.md` (C27–C30)

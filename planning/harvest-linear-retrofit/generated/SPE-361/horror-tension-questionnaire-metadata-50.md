**Harvest retrofit (rich)** — `horror-tension-questionnaire-metadata-50` → **SPE-361** (part 1/1)
...
- **Candidates on SPE-361:** C29
---

#### C29 — Incident content-intensity metadata
...
- **Harvest summary:** Incident content-intensity metadata
...
- **Table note:** Incident content-intensity metadata

**4. Ownership & reconciliation**
- **Primary (this comment):** SPE-361
- **Co-owners:** none

**5. Boundary**
**In scope (when owner ships):**
- Concrete acceptance delta on SPE-361 when that issue's slice is implemented
...
**Traceability:** `planning/horror-tension-questionnaire-metadata-50-harvest.md` (C29)

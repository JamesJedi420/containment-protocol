**Harvest retrofit (rich)** — `facility-crisis-triage-metadata-55` → **SPE-371** (part 1/1)
...
- **Candidates on SPE-371:** C4
---

#### C4 — Route-based movement hazard 
...
- **Harvest summary:** Route-based movement hazard (unsafe path vs safe destination)
...
- **Table note:** Route-based movement hazard (unsafe path vs safe destination)
...
**Traceability:** `planning/facility-crisis-triage-metadata-55-harvest.md` (C4)

**Harvest retrofit (rich)** — `field-staff-operations-handbook-metadata-105` → **SPE-371** (part 1/1)
...
- **Candidates on SPE-371:** C43–C44
---

#### C43–C44 — Weather system + failure-driven weather twists
...
- **Harvest summary:** Weather system + failure-driven weather twists
...
- **Table note:** Weather system + failure-driven weather twists
...
**Traceability:** `planning/field-staff-operations-handbook-metadata-105-harvest.md` (C43–C44)

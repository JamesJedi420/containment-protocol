**Harvest retrofit (rich)** — `governance-bureau-faction-metadata-82` → **SPE-371** (part 1/1)
...
- **Candidates on SPE-371:** C33
---

#### C33 — Exploration/survey report generation
...
- **Harvest summary:** Exploration/survey report generation
...
- **Table note:** Exploration/survey report generation
...
**Traceability:** `planning/governance-bureau-faction-metadata-82-harvest.md` (C33)

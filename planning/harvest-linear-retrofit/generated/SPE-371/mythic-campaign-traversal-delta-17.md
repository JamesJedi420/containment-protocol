**Harvest retrofit (rich)** — `mythic-campaign-traversal-delta-17` → **SPE-371** (part 1/1)
...
- **Candidates on SPE-371:** C25, C31
---

#### C25 — Geography-triggered dormant incident emergence on traversal
...
- **Harvest summary:** Geography-triggered dormant incident emergence on traversal
...
- **Table note:** Geography-triggered dormant incident emergence on traversal
...
**Traceability:** `planning/mythic-campaign-traversal-delta-17-harvest.md` (C25)

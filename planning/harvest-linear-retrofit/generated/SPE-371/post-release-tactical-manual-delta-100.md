**Harvest retrofit (rich)** — `post-release-tactical-manual-delta-100` → **SPE-371** (part 1/1)
...
- **Candidates on SPE-371:** C48–C55, C78–C80
---

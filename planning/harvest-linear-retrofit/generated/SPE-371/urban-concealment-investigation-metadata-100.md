**Harvest retrofit (rich)** — `urban-concealment-investigation-metadata-100` → **SPE-371** (part 1/1)
...
- **Candidates on SPE-371:** C31
---

#### C31 — Liminal transit encounters
...
- **Harvest summary:** Liminal transit encounters
...
- **Table note:** Liminal transit encounters
...
**Traceability:** `planning/urban-concealment-investigation-metadata-100-harvest.md` (C31)

**Harvest retrofit (rich)** — `post-release-tactical-manual-delta-100` → **SPE-40** (part 1/1)
...
- **Primary (this comment):** SPE-40
- **Co-owners:** SPE-120, SPE-55

**5. Boundary**
**In scope (when owner ships):**
- Concrete acceptance delta on SPE-40 when that issue's slice is implemented

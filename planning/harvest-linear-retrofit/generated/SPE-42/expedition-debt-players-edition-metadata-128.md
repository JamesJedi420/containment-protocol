**Harvest retrofit (rich)** — `expedition-debt-players-edition-metadata-128` → **SPE-42** (part 1/1)
...
- **Candidates on SPE-42:** C22
---

#### C22 — Retreat requires known exit/route confidence
...
- **Harvest summary:** Retreat requires known exit/route confidence
...
- **Table note:** Retreat requires known exit/route confidence
...
**Traceability:** `planning/expedition-debt-players-edition-metadata-128-harvest.md` (C22)

**Harvest retrofit (rich)** — `governance-bureau-faction-metadata-82` → **SPE-42** (part 1/1)
...
- **Candidates on SPE-42:** C65
---

#### C65 — Visitor access infiltration/diplomacy routes
...
- **Harvest summary:** Visitor access infiltration/diplomacy routes
...
- **Table note:** Visitor access infiltration/diplomacy routes
...
**Traceability:** `planning/governance-bureau-faction-metadata-82-harvest.md` (C65)

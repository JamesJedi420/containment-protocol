**Harvest retrofit (rich)** — `haunted-estate-dual-pressure-metadata-106` → **SPE-42** (part 1/1)
...
- **Candidates on SPE-42:** C18
---

#### C18 — Player-created routes via barrier damage
...
- **Harvest summary:** Player-created routes via barrier damage
...
- **Table note:** Player-created routes via barrier damage
...
**Traceability:** `planning/haunted-estate-dual-pressure-metadata-106-harvest.md` (C18)

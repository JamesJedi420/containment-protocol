**Harvest retrofit (rich)** — `multi-stage-squad-operations-metadata-24` → **SPE-42** (part 1/1)
...
- **Candidates on SPE-42:** C5
---

#### C5 — Command-authority override of local automation constraints
...
- **Harvest summary:** Command-authority override of local automation constraints
...
- **Table note:** Command-authority override of local automation constraints
...
**Traceability:** `planning/multi-stage-squad-operations-metadata-24-harvest.md` (C5)

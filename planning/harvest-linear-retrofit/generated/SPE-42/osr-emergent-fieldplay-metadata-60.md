**Harvest retrofit (rich)** — `osr-emergent-fieldplay-metadata-60` → **SPE-42** (part 1/1)
...
- **Candidates on SPE-42:** C7
---

#### C7 — Player agency contract navigation
...
- **Harvest summary:** Player agency contract navigation
...
- **Table note:** Player agency contract navigation
...
**Traceability:** `planning/osr-emergent-fieldplay-metadata-60-harvest.md` (C7)

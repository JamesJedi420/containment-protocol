**Harvest retrofit (rich)** — `spatial-remodeling-faction-metadata-35` → **SPE-42** (part 1/1)
...
- **Candidates on SPE-42:** C20
---

#### C20 — Non-hostile hazardous encounter doctrine
...
- **Harvest summary:** Non-hostile hazardous encounter doctrine
...
- **Table note:** Non-hostile hazardous encounter doctrine
...
**Traceability:** `planning/spatial-remodeling-faction-metadata-35-harvest.md` (C20)

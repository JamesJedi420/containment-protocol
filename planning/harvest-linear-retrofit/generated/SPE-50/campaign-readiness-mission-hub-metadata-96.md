**Harvest retrofit (rich)** — `campaign-readiness-mission-hub-metadata-96` → **SPE-50** (part 1/1)
...
- **Harvest summary:** Reputation (not binary morality)
...
- **Table note:** Reputation (not binary morality)

**4. Ownership & reconciliation**
- **Primary (this comment):** SPE-50
- **Co-owners:** SPE-35

**5. Boundary**
**In scope (when owner ships):**
- Concrete acceptance delta on SPE-50 when that issue's slice is implemented
...
**Traceability:** `planning/campaign-readiness-mission-hub-metadata-96-harvest.md` (C15)

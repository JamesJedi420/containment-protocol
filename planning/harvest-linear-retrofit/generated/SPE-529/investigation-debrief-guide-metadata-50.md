**Harvest retrofit (rich)** — `investigation-debrief-guide-metadata-50` → **SPE-529** (part 1/1)
...
- **Candidates on SPE-529:** C10
---

#### C10 — Hidden/latent forensic document layers
...
- **Harvest summary:** Hidden/latent forensic document layers
...
- **Table note:** Hidden/latent forensic document layers
...
**Traceability:** `planning/investigation-debrief-guide-metadata-50-harvest.md` (C10)

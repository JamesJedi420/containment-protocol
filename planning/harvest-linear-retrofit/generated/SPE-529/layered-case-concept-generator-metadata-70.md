**Harvest retrofit (rich)** — `layered-case-concept-generator-metadata-70` → **SPE-529** (part 1/1)
...
- **Candidates on SPE-529:** C53
---

#### C53 — Local container prize sites
...
- **Harvest summary:** Local container prize sites
...
- **Table note:** Local container prize sites
...
**Traceability:** `planning/layered-case-concept-generator-metadata-70-harvest.md` (C53)

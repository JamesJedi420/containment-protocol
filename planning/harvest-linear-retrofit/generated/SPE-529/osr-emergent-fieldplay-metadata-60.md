**Harvest retrofit (rich)** — `osr-emergent-fieldplay-metadata-60` → **SPE-529** (part 1/1)
...
- **Candidates on SPE-529:** C28
---

#### C28 — Context-sensitive equipment utility
...
- **Harvest summary:** Context-sensitive equipment utility
...
- **Table note:** Context-sensitive equipment utility
...
**Traceability:** `planning/osr-emergent-fieldplay-metadata-60-harvest.md` (C28)

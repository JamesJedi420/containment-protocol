**Harvest retrofit (rich)** — `expedition-debt-players-edition-metadata-128` → **SPE-562** (part 1/1)
...
- **Candidates on SPE-562:** C16, C107–C109
---

#### C16 — Rest restores buffer + advances clocks/encounter risk
...
- **Harvest summary:** Rest restores buffer + advances clocks/encounter risk
...
- **Table note:** Rest restores buffer + advances clocks/encounter risk
...
**Traceability:** `planning/expedition-debt-players-edition-metadata-128-harvest.md` (C16)

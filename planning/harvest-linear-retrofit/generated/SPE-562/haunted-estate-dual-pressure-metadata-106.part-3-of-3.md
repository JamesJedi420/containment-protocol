**Harvest retrofit (rich)** — `haunted-estate-dual-pressure-metadata-106` → **SPE-562** (part 3/3)
...
- **Candidates on SPE-562:** C77
---

#### C77 — Compound encounter results
...
- **Harvest summary:** Compound encounter results
...
- **Table note:** Compound encounter results
...
**Traceability:** `planning/haunted-estate-dual-pressure-metadata-106-harvest.md` (C77)

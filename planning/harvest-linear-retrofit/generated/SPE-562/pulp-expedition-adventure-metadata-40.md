**Harvest retrofit (rich)** — `pulp-expedition-adventure-metadata-40` → **SPE-562** (part 1/1)
...
- **Candidates on SPE-562:** C10, C13, C26
---

#### C10 — Cliffhanger phase-end escalation
...
- **Harvest summary:** Cliffhanger phase-end escalation
...
- **Table note:** Cliffhanger phase-end escalation
...
**Traceability:** `planning/pulp-expedition-adventure-metadata-40-harvest.md` (C10)

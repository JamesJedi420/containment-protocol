**Harvest retrofit (rich)** — `mission-hub-guide-patterns-metadata-44` → **SPE-588** (part 1/1)
...
- **Primary (this comment):** SPE-588
- **Co-owners:** SPE-854

**5. Boundary**
**In scope (when owner ships):**
- Concrete acceptance delta on SPE-588 when that issue's slice is implemented

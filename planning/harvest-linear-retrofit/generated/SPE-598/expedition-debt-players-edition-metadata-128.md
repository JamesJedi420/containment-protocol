**Harvest retrofit (rich)** — `expedition-debt-players-edition-metadata-128` → **SPE-598** (part 1/1)
...
- **Candidates on SPE-598:** C67
---

#### C67 — Composite operational unit actors
...
- **Harvest summary:** Composite operational unit actors
...
- **Table note:** Composite operational unit actors
...
**Traceability:** `planning/expedition-debt-players-edition-metadata-128-harvest.md` (C67)

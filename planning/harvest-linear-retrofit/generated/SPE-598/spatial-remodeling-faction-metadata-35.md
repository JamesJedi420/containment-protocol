**Harvest retrofit (rich)** — `spatial-remodeling-faction-metadata-35` → **SPE-598** (part 1/1)
...
- **Candidates on SPE-598:** C12
---

#### C12 — Partial task-force exposure / unknown parent org
...
- **Harvest summary:** Partial task-force exposure / unknown parent org
...
- **Table note:** Partial task-force exposure / unknown parent org
...
**Traceability:** `planning/spatial-remodeling-faction-metadata-35-harvest.md` (C12)

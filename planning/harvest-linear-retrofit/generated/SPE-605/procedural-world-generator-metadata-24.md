**Harvest retrofit (rich)** — `procedural-world-generator-metadata-24` → **SPE-605** (part 1/1)
...
- **Candidates on SPE-605:** C3
---

#### C3 — Collective belief/ritual modifies climate-state overlays
...
- **Harvest summary:** Collective belief/ritual modifies climate-state overlays
...
- **Table note:** Collective belief/ritual modifies climate-state overlays
...
**Traceability:** `planning/procedural-world-generator-metadata-24-harvest.md` (C3)

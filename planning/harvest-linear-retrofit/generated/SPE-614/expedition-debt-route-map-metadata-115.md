**Harvest retrofit (rich)** — `expedition-debt-route-map-metadata-115` → **SPE-614** (part 1/1)
...
- **Candidates on SPE-614:** C37
---

#### C37 — Impact + long-term consequence
...
- **Harvest summary:** Impact + long-term consequence
...
- **Table note:** Impact + long-term consequence
...
**Traceability:** `planning/expedition-debt-route-map-metadata-115-harvest.md` (C37)

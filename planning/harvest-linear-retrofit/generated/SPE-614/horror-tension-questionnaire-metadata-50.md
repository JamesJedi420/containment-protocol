**Harvest retrofit (rich)** — `horror-tension-questionnaire-metadata-50` → **SPE-614** (part 1/1)
...
- **Candidates on SPE-614:** C3
---

#### C3 — Collapse → irreversible case consequence
...
- **Harvest summary:** Collapse → irreversible case consequence
...
- **Table note:** Collapse → irreversible case consequence
...
**Traceability:** `planning/horror-tension-questionnaire-metadata-50-harvest.md` (C3)

**Harvest retrofit (rich)** — `field-staff-operations-handbook-metadata-105` → **SPE-62** (part 1/1)
...
- **Primary (this comment):** SPE-62
- **Co-owners:** SPE-1610

**5. Boundary**
**In scope (when owner ships):**
- Concrete acceptance delta on SPE-62 when that issue's slice is implemented

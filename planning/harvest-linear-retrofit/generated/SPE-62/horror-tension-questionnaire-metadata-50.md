**Harvest retrofit (rich)** — `horror-tension-questionnaire-metadata-50` → **SPE-62** (part 1/1)
...
- **Candidates on SPE-62:** C24
---

#### C24 — Asymmetric conflict + defensive objectives
...
- **Harvest summary:** Asymmetric conflict + defensive objectives
...
- **Table note:** Asymmetric conflict + defensive objectives
...
**Traceability:** `planning/horror-tension-questionnaire-metadata-50-harvest.md` (C24)

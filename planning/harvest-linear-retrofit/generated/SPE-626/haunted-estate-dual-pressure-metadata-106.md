**Harvest retrofit (rich)** — `haunted-estate-dual-pressure-metadata-106` → **SPE-626** (part 1/1)
...
- **Candidates on SPE-626:** C92
---

#### C92 — Hot-start under-pressure contracts
...
- **Harvest summary:** Hot-start under-pressure contracts
...
- **Table note:** Hot-start under-pressure contracts
...
**Traceability:** `planning/haunted-estate-dual-pressure-metadata-106-harvest.md` (C92)

**Harvest retrofit (rich)** — `pulp-expedition-adventure-metadata-40` → **SPE-626** (part 1/1)
...
- **Candidates on SPE-626:** C3, C21
---

#### C3 — Diegetic classified-hook notices
...
- **Harvest summary:** Diegetic classified-hook notices
...
- **Table note:** Diegetic classified-hook notices

**4. Ownership & reconciliation**
- **Primary (this comment):** SPE-626
- **Co-owners:** SPE-854, SPE-151
...
**Traceability:** `planning/pulp-expedition-adventure-metadata-40-harvest.md` (C3)

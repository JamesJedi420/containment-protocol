**Harvest retrofit (rich)** — `facility-crisis-triage-metadata-55` → **SPE-704** (part 1/1)
...
- **Candidates on SPE-704:** C2
---

#### C2 — Active event backlog + end-of-turn damage
...
- **Harvest summary:** Active event backlog + end-of-turn damage
...
- **Table note:** Active event backlog + end-of-turn damage
...
**Traceability:** `planning/facility-crisis-triage-metadata-55-harvest.md` (C2)

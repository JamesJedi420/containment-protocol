**Harvest retrofit (rich)** — `horror-tension-questionnaire-metadata-50` → **SPE-704** (part 1/1)
...
- **Candidates on SPE-704:** C34
---

#### C34 — Threat escalation from hesitation/abandon/collapse
...
- **Harvest summary:** Threat escalation from hesitation/abandon/collapse
...
- **Table note:** Threat escalation from hesitation/abandon/collapse
...
**Traceability:** `planning/horror-tension-questionnaire-metadata-50-harvest.md` (C34)

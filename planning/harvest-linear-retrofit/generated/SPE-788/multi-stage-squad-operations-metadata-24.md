**Harvest retrofit (rich)** — `multi-stage-squad-operations-metadata-24` → **SPE-788** (part 1/1)
...
- **Candidates on SPE-788:** C7
---

#### C7 — Reputation-gated negotiation/de-escalation
...
- **Harvest summary:** Reputation-gated negotiation/de-escalation
...
- **Table note:** Reputation-gated negotiation/de-escalation
...
**Traceability:** `planning/multi-stage-squad-operations-metadata-24-harvest.md` (C7)

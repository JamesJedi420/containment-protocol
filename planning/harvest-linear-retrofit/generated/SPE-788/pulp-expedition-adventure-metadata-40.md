**Harvest retrofit (rich)** — `pulp-expedition-adventure-metadata-40` → **SPE-788** (part 1/1)
...
- **Candidates on SPE-788:** C2
---

#### C2 — Global field-office / contact chapter network
...
- **Harvest summary:** Global field-office / contact chapter network
...
- **Table note:** Global field-office / contact chapter network
...
**Traceability:** `planning/pulp-expedition-adventure-metadata-40-harvest.md` (C2)

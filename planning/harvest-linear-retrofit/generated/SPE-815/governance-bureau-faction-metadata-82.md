**Harvest retrofit (rich)** — `governance-bureau-faction-metadata-82` → **SPE-815** (part 1/1)
...
- **Candidates on SPE-815:** C18
---

#### C18 — Exterior/interior mismatch / underground suspicion
...
- **Harvest summary:** Exterior/interior mismatch / underground suspicion
...
- **Table note:** Exterior/interior mismatch / underground suspicion

**4. Ownership & reconciliation**
- **Primary (this comment):** SPE-815
- **Co-owners:** SPE-58

**5. Boundary**
**In scope (when owner ships):**
- Concrete acceptance delta on SPE-815 when that issue's slice is implemented
...
**Traceability:** `planning/governance-bureau-faction-metadata-82-harvest.md` (C18)

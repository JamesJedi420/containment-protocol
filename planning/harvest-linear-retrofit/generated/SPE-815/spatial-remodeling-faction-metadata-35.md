**Harvest retrofit (rich)** — `spatial-remodeling-faction-metadata-35` → **SPE-815** (part 1/1)
...
#### C18 — Fluid-reality utility — stability-dependent tools
...
- **Harvest summary:** Fluid-reality utility — stability-dependent tools
...
- **Table note:** Fluid-reality utility — stability-dependent tools
...
**Traceability:** `planning/spatial-remodeling-faction-metadata-35-harvest.md` (C18)

**Harvest retrofit (rich)** — `expedition-debt-players-edition-metadata-128` → **SPE-88** (part 1/1)
...
- **Candidates on SPE-88:** C79
---

#### C79 — Machine purpose/ailment inspection
...
- **Harvest summary:** Machine purpose/ailment inspection
...
- **Table note:** Machine purpose/ailment inspection
...
**Traceability:** `planning/expedition-debt-players-edition-metadata-128-harvest.md` (C79)

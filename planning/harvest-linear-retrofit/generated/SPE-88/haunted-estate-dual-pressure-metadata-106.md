**Harvest retrofit (rich)** — `haunted-estate-dual-pressure-metadata-106` → **SPE-88** (part 1/1)
...
- **Candidates on SPE-88:** C20
---

#### C20 — Temporal replay clue devices
...
- **Harvest summary:** Temporal replay clue devices
...
- **Table note:** Temporal replay clue devices
...
**Traceability:** `planning/haunted-estate-dual-pressure-metadata-106-harvest.md` (C20)

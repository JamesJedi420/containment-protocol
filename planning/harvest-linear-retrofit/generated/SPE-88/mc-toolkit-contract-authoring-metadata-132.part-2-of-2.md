**Harvest retrofit (rich)** — `mc-toolkit-contract-authoring-metadata-132` → **SPE-88** (part 2/2)
...
- **Candidates on SPE-88:** C121, C130
---

#### C121 — Religion/cult neutrality
...
- **Harvest summary:** Religion/cult neutrality
...
- **Table note:** Religion/cult neutrality
...
**Traceability:** `planning/mc-toolkit-contract-authoring-metadata-132-harvest.md` (C121)

**Harvest retrofit (rich)** — `procedural-world-generator-metadata-24` → **SPE-88** (part 1/1)
...
- **Candidates on SPE-88:** C2, C5, C8, C14
---

#### C2 — Sentient environment as informational actor 
...
- **Harvest summary:** Sentient environment as informational actor (observe/deceive/warn)
...
- **Table note:** Sentient environment as informational actor (observe/deceive/warn)
...
**Traceability:** `planning/procedural-world-generator-metadata-24-harvest.md` (C2)

**Harvest retrofit (rich)** — `hidden-role-social-meeting-metadata-65` → **SPE-98** (part 1/1)
...
- **Candidates on SPE-98:** C12
---

#### C12 — Specialist screening / impostor exposure
...
- **Harvest summary:** Specialist screening / impostor exposure
...
- **Table note:** Specialist screening / impostor exposure
...
**Traceability:** `planning/hidden-role-social-meeting-metadata-65-harvest.md` (C12)

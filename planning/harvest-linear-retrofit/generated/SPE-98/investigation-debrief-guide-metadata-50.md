**Harvest retrofit (rich)** — `investigation-debrief-guide-metadata-50` → **SPE-98** (part 1/1)
...
- **Candidates on SPE-98:** C13
---

#### C13 — Visible loadout/clothing check modifiers
...
- **Harvest summary:** Visible loadout/clothing check modifiers
...
- **Table note:** Visible loadout/clothing check modifiers
...
**Traceability:** `planning/investigation-debrief-guide-metadata-50-harvest.md` (C13)

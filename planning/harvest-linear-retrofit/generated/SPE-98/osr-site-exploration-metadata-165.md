**Harvest retrofit (rich)** — `osr-site-exploration-metadata-165` → **SPE-98** (part 1/1)
...
- **Candidates on SPE-98:** C29, C30, C31, C32
---

#### C29 — Specialist role gates
...
- **Harvest summary:** Specialist role gates
...
- **Table note:** Specialist role gates
...
**Traceability:** `planning/osr-site-exploration-metadata-165-harvest.md` (C29)

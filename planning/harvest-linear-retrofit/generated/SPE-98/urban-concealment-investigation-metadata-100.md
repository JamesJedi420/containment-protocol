**Harvest retrofit (rich)** — `urban-concealment-investigation-metadata-100` → **SPE-98** (part 1/1)
...
- **Candidates on SPE-98:** C40
---

#### C40 — Mundane-front specialist vendors
...
- **Harvest summary:** Mundane-front specialist vendors
...
- **Table note:** Mundane-front specialist vendors
...
**Traceability:** `planning/urban-concealment-investigation-metadata-100-harvest.md` (C40)

...
| ----------------------------------------- | -------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| Repair economics / spare-part suitability | SPE-877 spare-part child (`planning/spe-spare-part-suitability-repair-slice.md`) | Typed `blast_door` / `blast_door_hinge_seal` gate; no SPE-1027 consume                           |

...
| ----------------------------------------- | --------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| Repair economics / spare-part suitability | [SPE-2861](https://linear.app/spectranoir/issue/SPE-2861) | Typed `blast_door` / `blast_door_hinge_seal` gate; no SPE-1027 consume                           |
...
| Stabilization / deficiency clear          | [SPE-2862](https://linear.app/spectranoir/issue/SPE-2862) | Technician relief/clear; SPE-2860 inspection sticky hard-stop stays                              |

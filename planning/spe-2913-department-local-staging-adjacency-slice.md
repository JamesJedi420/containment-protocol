...
| ---------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Separate input and output staging-location ids | [SPE-2998](https://linear.app/spectranoir/issue/SPE-2998/split-input-and-output-staging-locations-on-the-facility-section-graph)        | SPE-2932 closed staging locations at `clinical_hold`. SPE-2913 classified both axes from that one adjacency. SPE-2998 owns the split.                                |

...
| ---------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Remaining room-to-department catalog     | later SPE-1052 child                                                                                             | This slice authors only `finance` → `department:concept-embodiment-research`. Do not map `ethics_review` → `department:ethics-review` or `evidence_intake` → `department:general-intake`. Remaining rooms stay unprojected. |

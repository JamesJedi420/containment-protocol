...
| ---------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| Site-wide escalation                     | [SPE-1606](https://linear.app/spectranoir/issue/SPE-1606/zone-spanning-event-propagation) consumes [SPE-3008](https://linear.app/spectranoir/issue/SPE-3008/canonical-full-site-alert-stage) `full_site_alert` only | The stage id ships on SPE-3008. This route-link slice does not open the consume child. `siteWide` stays a flag. |

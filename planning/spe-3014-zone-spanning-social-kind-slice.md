...
| Spread helpers omit `eventKind`                          | [SPE-3015](https://linear.app/spectranoir/issue/SPE-3015/reserve-eventkind-when-a-spread-apply-copies-the-record)  | `freezeRecord` and spread applies still drop the field.  |

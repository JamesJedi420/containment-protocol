...
| Spread helpers omit `eventKind`                          | [SPE-3015](https://linear.app/spectranoir/issue/SPE-3015/reserve-eventkind-when-a-spread-apply-copies-the-record)  | This slice did not copy the field. SPE-3015 copies it on spread success. |

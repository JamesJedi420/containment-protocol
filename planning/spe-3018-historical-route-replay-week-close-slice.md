...
| -------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| Auto terminal → ended + ordinary consequence       | [SPE-3020](https://linear.app/spectranoir/issue/SPE-3020/auto-resolve-historical-route-replay-terminal-ended-with-ordinary) (`planning/spe-3020-historical-route-replay-terminal-resolve-slice.md`) | Consequence IDs need an explicit owner; week-close must not invent them. Shipped as SPE-3020 with owned `historical_route_terminal` policy. |

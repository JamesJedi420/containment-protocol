...
| Automatic calendar/time/interaction activation          | [SPE-3024](https://linear.app/spectranoir/issue/SPE-3024/activate-historical-route-replays-from-calendarstart-condition-policy) under SPE-1606 (owners [SPE-1605](https://linear.app/spectranoir/issue/SPE-1605/scenario-event-start-conditions) / [SPE-1071](https://linear.app/spectranoir/issue/SPE-1071/calendar-seasonal-cycle-and-time-gated-events)); see `planning/spe-3024-historical-route-replay-activation-slice.md` | Activation policy stays with start-condition/calendar owners; SPE-3024 owns the SPE-1606 integration child. |

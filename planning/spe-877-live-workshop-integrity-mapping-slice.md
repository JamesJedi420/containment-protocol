...
| ---------------------------------------------------------------- | ---------------------- | --------------------------------------------------------- |
| Mutation stations / integrity labor                              | later SPE-877 child    | SPE-113 remains design-only. Named next after this child. |
...
SPE-877 remains **Backlog**. Remaining parent AC after this child is mutation stations / integrity labor.

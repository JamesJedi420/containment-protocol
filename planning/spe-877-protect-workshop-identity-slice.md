...
| Mission-loss / mission-injury equipped workshop drop     | [SPE-2879](https://linear.app/spectranoir/issue/SPE-2879/skip-authored-workshop-identity-on-mission-casualty-equipped-loss) (`planning/spe-877-mission-casualty-workshop-identity-slice.md`) | Shipped: casualty writer skips authored SPE-2866 IDs in place; relocate of seeds stays legal        |

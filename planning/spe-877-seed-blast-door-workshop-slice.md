...
| ------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| Protect authored workshop identity from destroy/re-agg | later SPE-877 child                                                                                         | Player can destroy or catalog-re-agg the seed; re-agg would credit `ward_seals` that was never debited; mapping would go `poor` |

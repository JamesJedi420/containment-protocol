...
- [ ] Empty/missing deltas keep identity
- [ ] Malformed delta fields drop on sanitize
- [ ] Same-week already_ticked must not re-apply deltas
- [ ] Authored-only (no invent)
- [ ] mapsMutated only when real delta applied

...
| --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| Platform nodes with reach, uptime, audience, propagation reliability  | **Done** — [SPE-2568](https://linear.app/spectranoir/issue/SPE-2568) + [SPE-2576](https://linear.app/spectranoir/issue/SPE-2576)–[SPE-2617](https://linear.app/spectranoir/issue/SPE-2617) wire-up                                                           | Parent AC row 1 at SPE-2481; **superseded** — evaluator + wire-up shipped ([SPE-2618](https://linear.app/spectranoir/issue/SPE-2618))          |
| Counter-memetic lore craft + distributor + uptake pipeline            | **Done** — [SPE-2570](https://linear.app/spectranoir/issue/SPE-2570) + [SPE-2576](https://linear.app/spectranoir/issue/SPE-2576)–[SPE-2617](https://linear.app/spectranoir/issue/SPE-2617) wire-up                                                           | Parent AC row 3 at SPE-2481; **superseded** — evaluator + wire-up shipped ([SPE-2618](https://linear.app/spectranoir/issue/SPE-2618))          |
| Content-owner takedown resistance (audience/status incentives)        | **Done** — [SPE-2572](https://linear.app/spectranoir/issue/SPE-2572) + [SPE-2576](https://linear.app/spectranoir/issue/SPE-2576)–[SPE-2617](https://linear.app/spectranoir/issue/SPE-2617) wire-up                                                           | Parent AC row 5 at SPE-2481; **superseded** — evaluator + wire-up shipped ([SPE-2618](https://linear.app/spectranoir/issue/SPE-2618))          |
| Post-case media persistence (mirrors, adaptations, commercialization) | **Done** — [SPE-2573](https://linear.app/spectranoir/issue/SPE-2573) + [SPE-2606](https://linear.app/spectranoir/issue/SPE-2606) kinds + [SPE-2609](https://linear.app/spectranoir/issue/SPE-2609)–[SPE-2617](https://linear.app/spectranoir/issue/SPE-2617) | Parent AC row 6 at SPE-2481; **superseded** — evaluator + continuity chain shipped ([SPE-2618](https://linear.app/spectranoir/issue/SPE-2618)) |

...
function getShellMeta(pathname: string, search: string, game: GameState): ShellMeta {
  ...
  if (pathname === APP_ROUTES.marketsSuppliers) {
    return {
      ...
      subtitle: 'Supply pressure and procurement leverage for fabrication.',
      backTo: APP_ROUTES.operationsDesk,
      backLabel: createBackLabel(NAVIGATION_ROUTES.operationsDesk.label),
    }
  }

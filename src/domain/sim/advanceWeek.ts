...
export function advanceWeek(state: GameState, overrideNow?: number): GameState {
  ...
  const stateWithUnknownFields = state as unknown as GameState & Record<string, unknown>
  const resultWithUnknownFields = result as unknown as GameState & Record<string, unknown>
  ...
  if (mergedAuthoritySources.length > 0) {
    ...
    delete (outputWeeklyState as unknown as Record<string, unknown>).civicAuthoritySources
  }
  ...
  if (decayedRumorPackets.length > 0) {
    ...
    delete (outputWeeklyState as unknown as Record<string, unknown>).rumorPackets
  }
  ...
  if (decayedCreditPackets.length > 0) {
    ...
    delete (outputWeeklyState as unknown as Record<string, unknown>).creditPackets
  }
    ...
    if (decayedAccessPackets.length > 0) {
      ...
      delete (outputWeeklyState as unknown as Record<string, unknown>).accessPackets
    }

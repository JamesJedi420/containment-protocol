            ...
            <li key={opt.id} className="procurement-option-item">
              ...
              >
                <div className="procurement-option-row">
                  ...
                  <span
                    className={`procurement-category${
                      opt.category === 'Equipment'
                        ? ' equipment'
                        : opt.category === 'Fabrication'
                          ? ' fabrication'
                          : ''
                    }`}
                  >
                  ...
                  {!opt.isCritical && opt.isRecommended && (
                    <span className="procurement-recommended">Recommended</span>
                  )}
                </div>
                ...
                {opt.blockers.length > 0 && (
                  <div className="procurement-blockers">{opt.blockers.join(', ')}</div>
                )}
              </button>
            </li>
          ))}
      ...
      <div className="procurement-center">
        ...
        {selected ? (
          <div>
            ...
            {!selected.isCritical && selected.isRecommended && (
              <div className="procurement-recommended">Recommended</div>
            )}
            <button

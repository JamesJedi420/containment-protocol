...
describe('MissionResult knowledge-state gating', () => {
  it('should add a risk note if defeat-condition certainty is below required', () => {
    ...
    const input = {
      ...
      teamsUsed: [{ teamId }],
      outcome: 'success',
      rewards: { reasons: [], factors: [], operationValue: 10, fundingDelta: 0, containmentDelta: 0, reputationDelta: 0, strategicValueDelta: 0, inventoryRewards: [], factionStanding: [], caseType: 'general', caseTypeLabel: 'General', label: 'Success' },

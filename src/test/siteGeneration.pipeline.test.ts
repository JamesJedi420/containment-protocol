    ...
    const duplicateCatalog: PilotSiteGenerationPacket[] = [
      {
        ...
        buildersByPurpose: {
          ...
          detention_complex: [{ id: 'collapsed_infrastructure', weight: 1 }],
        },
        locationsByPurpose: {
          ritual_complex: [{ id: 'riverfront_substrate', weight: 1 }],
          predator_nest: [{ id: 'stockyard_labyrinth', weight: 1 }],
          detention_complex: [{ id: 'stockyard_labyrinth', weight: 1 }],
        },
        ingressByPurposeAndLocation: {
          ...
          'detention_complex|riverfront_substrate': [{ id: 'service_door', weight: 1 }],
          'detention_complex|stockyard_labyrinth': [{ id: 'maintenance_shaft', weight: 1 }],
        },
        ...
        hazardsByPurposeAndTopology: {
          ...
          'detention_complex|concentric_sanctum': [{ id: 'ward_feedback', weight: 1 }],
          'detention_complex|lure_corridors': [{ id: 'blood_traps', weight: 1 }],
          'detention_complex|collapsed_cells': [{ id: 'structural_fall', weight: 1 }],
        },
        treasureByPurposeAndLocation: {
          ...
          'detention_complex|riverfront_substrate': [{ id: 'smuggled_cache', weight: 1 }],
          'detention_complex|stockyard_labyrinth': [{ id: 'feeding_cache', weight: 1 }],
        },
        inhabitantsByPurposeAndBuilder: {
          ...
          'ritual_complex|collapsed_infrastructure': [{ id: 'captured_witnesses', weight: 1 }],
          'predator_nest|cult_engineers': [{ id: 'captured_witnesses', weight: 1 }],
          'predator_nest|feral_pack': [{ id: 'feral_packmates', weight: 1 }],
          'predator_nest|collapsed_infrastructure': [{ id: 'captured_witnesses', weight: 1 }],
          'detention_complex|cult_engineers': [{ id: 'captured_witnesses', weight: 1 }],
          'detention_complex|feral_pack': [{ id: 'bound_sentinels', weight: 1 }],
          'detention_complex|collapsed_infrastructure': [{ id: 'captured_witnesses', weight: 1 }],
        },
